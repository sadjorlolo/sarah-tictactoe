...
var initialLoadHide = function initialLoadHide() {
  $('.game-board').hide();
  $('.change-pswd').hide();
  $('.sign-out').hide();
  $('.get-games').hide();
...
var clearSignUp = function clearSignUp() {
  $('.signup_email').val('');
  $('.signup_pswd').val('');
  $('.signup_conf').val('');
};

var clearSignIn = function clearSignIn() {
  $('.signin_email').val('');
  $('.signin_pswd').val('');
  $('.auth-msg-box').val('');
};
...
var signInShowHide = function signInShowHide() {
  $('.get-games').show();
  $('.sign-out').show();
  $('.create-game').show();
  $('.change-pswd').show();
...
var signOutShowHide = function signOutShowHide() {
  $('.sign-in').show();
  $('.sign-up').show();
  $('.sign-in-play').show();
  $('.auth-msg-box').show();
...
var signOutClearMessage = function signOutClearMessage() {
  $('.message-box').text('');
  $('.declare-winner').text('');
  $('.stats-box').text('');
  $('.update-msg').text('');
...
module.exports = {
  initialLoadHide: initialLoadHide,
  clearSignUp: clearSignUp,
  clearSignIn: clearSignIn,
  clearPassword: clearPassword,
  signInShowHide: signInShowHide,
  signOutShowHide: signOutShowHide,
  signOutClearMessage: signOutClearMessage
};
...
var showhide = __webpack_require__(4);
...
var onCreateGame = function onCreateGame(event) {
  ...
  api.create(data).then(ui.createGameSuccess).catch(ui.createGameError);
  currentPlayer = playerX;
};

var setClickValue = function setClickValue() {
  $('.message-box').text('');
...
var onUpdateGame = function onUpdateGame(index, value) {
  var data = {
    'game': {
      'cell': {
        'index': index,
  ...
  api.update(data).then(ui.updateGameSuccess).catch(ui.updateGameError);
};

var pushToGameArray = function pushToGameArray(player, index) {
  var thisPlayer = player;
  gameBoard[index] = thisPlayer;
};

var checkForWin = function checkForWin() {
  var draw = gameBoard.every(function (box) {
    return box !== '';
  });
  if (gameBoard[0] !== '' && gameBoard[0] === gameBoard[1] && gameBoard[1] === gameBoard[2] || gameBoard[3] !== '' && gameBoard[3] === gameBoard[4] && gameBoard[4] === gameBoard[5] || gameBoard[6] !== '' && gameBoard[6] === gameBoard[7] && gameBoard[7] === gameBoard[8] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[3] && gameBoard[3] === gameBoard[6] || gameBoard[1] !== '' && gameBoard[1] === gameBoard[4] && gameBoard[4] === gameBoard[7] || gameBoard[2] !== '' && gameBoard[2] === gameBoard[5] && gameBoard[5] === gameBoard[8] || gameBoard[0] !== '' && gameBoard[0] === gameBoard[4] && gameBoard[4] === gameBoard[8] || gameBoard[2] !== '' && gameBoard[2] === gameBoard[4] && gameBoard[4] === gameBoard[6]) {
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.index().then(ui.getGamesSuccess).catch(ui.getGamesError);
};
...
var getGamesError = function getGamesError() {
...
var createGameError = function createGameError() {
